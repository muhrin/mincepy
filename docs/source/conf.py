...
latex_documents = [
    (master_doc, 'mincepy.tex', 'mincePy Documentation', 'Martin Uhrin', 'manual'),
]
...
man_pages = [(master_doc, 'mincepy', 'mincePy Documentation', [author], 1)]
...
texinfo_documents = [
    (master_doc, 'mincepy', 'mincePy Documentation', author, 'mincepy',
